			...
			<div class="row mt-4">
				...
				<div class="col-md-4 ">
					...
					<div class="list-group primary-background">
						<a href="#i-1" class="list-group-item list-group-item-action active">What is Java?</a> 
						<a href="#i-2" class="list-group-item list-group-item-action">History of Java</a> 
						<a href="#i-3" class="list-group-item list-group-item-action">Difference between JDK, JRE, and JVM</a> 
						<a href="#i-4" class="list-group-item list-group-item-action">Java Variables</a>
						<a href="#i-5" class="list-group-item list-group-item-action disabled">Data Types in Java</a> 
						<a href="#i-6" class="list-group-item list-group-item-action disabled">Java Keywords</a> 
						<a href="#i-7" class="list-group-item list-group-item-action disabled">Java If-else Statement</a> 
						<a href="#i-8" class="list-group-item list-group-item-action disabled">Java Switch Statement</a> 
						<a href="#i-9" class="list-group-item list-group-item-action disabled">Loops in Java</a> 
						<a href="#i-10" class="list-group-item list-group-item-action disabled">Java While Loop</a> 
						<a href="#i-11" class="list-group-item list-group-item-action disabled">Java do-while Loop</a> 
						<a href="#i-12" class="list-group-item list-group-item-action disabled">Java Break Statement</a> 
						<a href="#i-13" class="list-group-item list-group-item-action disabled">Java Continue Statement</a> 
						<a href="#i-14" class="list-group-item list-group-item-action disabled">Java OOPs Concepts</a> 
						<a href="#i-15" class="list-group-item list-group-item-action disabled">Objects and Classes in Java</a>
				...
				<div class="col-md-8">
					...
					<div >
						<div>
						    <dl>
                               <dt id="i-1"><h3>What is Java?</h3> </dt>
                               <dd>
                                   <p>
                              ...
                              Simple.java:
                               ...
                               <dt id="i-2"><h3>History of Java</h3> </dt>
                               <dd>
                                   <p>
                               ...
                               <dt id="i-3"><h3>Difference between JDK, JRE, and JVM</h3> </dt>
                               <dd>
                                   <p>
                               ...
                               <dt id="i-4"><h3>Java Variables</h3> </dt>
                               <dd>
                                   <p>
                               ...
                               <dt id="i-5"><h3>Data Types in Java</h3> </dt>
                               <dd>
                                   <p>
                                  ...
                                  <p><h5>Java Primitive Data Types</h5>
                                  <p>
                                  ...
                                  <p><h5>Java  non-Primitive Data Types</h5>
                                  <p>
                                   <li>String</li>
                                   <li>Array</li>
                                   <li>etc</li>
                               ...
                               <dt id="i-6"><h3>Java Keywords</h3> </dt>
                               <dd>
                                   <p>
                               ...
                               <dt id="i-7"><h3>Java If-else Statement</h3> </dt>
                               <dd>
                                   <p>
                               ...
                               <dt id="i-8"><h3>Java Switch Statement</h3> </dt>
                               <dd>
                                   <p>
                               ...
                               <dt id="i-9"><h3>Loops in Java</h3> </dt>
                               <dd>
                                   <p>
                               ...
                               <dt id="i-10"><h3>Java While Loop</h3> </dt>
                               <dd>
                                   <p>
							 ...
							 <dt id="i-11"><h3>Java do-While Loop</h3> </dt>
                               <dd>
                                   <p>
                             ...
                             <dt id="i-12"><h3>Java Break Statement</h3> </dt>
                               <dd>
                                   <p>
                             ...
                             <dt id="i-13"><h3>Java Continue Statement</h3> </dt>
                               <dd>
                                   <p>
                             ...
                             <dt id="i-14"><h3>Java OOPs Concepts</h3> </dt>
                               <dd>
                                   <p>
                             ...
                             <dt id="i-15"><h3>Objects and Classes in Java</h3> </dt>
                               <dd>
                                   <p>
